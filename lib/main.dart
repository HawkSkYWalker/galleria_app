...
// Then, replace your existing _signIn() method in the _SignInScreenState class:
class _SignInScreenState extends State<SignInScreen> {
 ...
 // Add this method to your _SignInScreenState class
...
// Replace your existing _signIn() method with this enhanced version:
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: const Text('ข้อผิดพลาด'),
              content: const Text('เกิดข้อผิดพลาดที่ไม่คาดคิด กรุณาลองใหม่อีกครั้ง'),
              actions: [
                TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: const Text('ตกลง'),
...
void dispose() {
  ...
  // Replace the existing _signUp() method in the _SignUpScreenState class with this:
  ...
  if (_formKey.currentState!.validate() && _agreeToTerms) {
    ...
    try {
      ...
      if (e.code == 'weak-password') {
        ...
        errorMessage = 'การสมัครสมาชิกด้วยอีเมล/รหัสผ่านไม่ได้รับอนุญาต';
      }
    ...
    // Show dialog if terms are not agreed to
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('ข้อกำหนดและเงื่อนไข'),
          content: const Text('กรุณายอมรับข้อตกลงและเงื่อนไขการใช้งาน'),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('ตกลง'),
